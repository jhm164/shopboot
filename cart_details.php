...
if($r){
	...
	while($row=mysql_fetch_array($r)){
		...
		<td><a href="http://localhost:8080/shopboot/product_detail.php/?pid=<?php echo $row['pid']?>&id=<?php echo $id ?>">buy it</a> </td>
		<td><a href="http://localhost:8080/shopboot/cart_details.php?pid=<?php echo $row['pid']?>&id=<?php echo $id ?>&rmd=<?php echo $id ?>">remove</a> </td>
